...
export default function Sidebar() {
  ...
  return (
    ...
    `}>
      {/* Header */}
      <div className={`px-5 pt-6 pb-4 flex items-center ${isCollapsed ? 'justify-center' : 'gap-3'}`}>
        <button 
      ...
      {/* Sync Status */}
      <div className={`py-4 border-t border-[#E5E5E5] ${isCollapsed ? 'flex justify-center' : 'px-5'}`}>
